...
ALTER TABLE "secteur" ADD FOREIGN KEY ("id_ville") REFERENCES "ville" ("id");

ALTER TABLE "secteur" ADD FOREIGN KEY ("id_code_postal") REFERENCES "code_postal" ("id");

ALTER TABLE "region" ADD FOREIGN KEY ("id_pays") REFERENCES "pays" ("id");

ALTER TABLE "entreprise" ADD FOREIGN KEY ("id_secteur") REFERENCES "secteur" ("id");
